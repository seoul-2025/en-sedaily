...
export const metadata: Metadata = {
  metadataBase: new URL('https://en.sedaily.com'),
  ...
  alternates: {
    canonical: "https://en.sedaily.com",
    languages: {
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="google-adsense-account" content="ca-pub-1326078912759552" />
        ...
        <link rel="dns-prefetch" href="https://7w5nco7xn4.execute-api.us-east-1.amazonaws.com" />
        {/* RSS Feeds */}
