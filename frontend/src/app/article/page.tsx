...
import { ArticleToolbar } from "@/components/article/ArticleToolbar/ArticleToolbar";
...
export default async function ArticlePage({
  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto py-8 px-gutter">
        ...
        {/* Article Toolbar: Share, Font Size, Print */}
        <ArticleToolbar
          title={article.title}
          url={newUrl}
