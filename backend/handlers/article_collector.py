    ...
    try:
        ...
        for article in detailed_articles:
            try:
                ...
                # Extract main category from array - COMMENTED OUT FOR KEYWORD-BASED CLASSIFICATION
                ...
                # Use keyword-based classification instead
                category = '경제'  # Default to 경제 for now, keyword classification should handle subcategories
                ...
                # Save to DynamoDB with SEO metadata and slug
